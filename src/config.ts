...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      ...
      '80BOMB-20BTCB': ['0xd6F52e8AB206e59A1E13b3D6c5B7f31E90ef46EF', 18],
      '80BSHARE-20WBNB': ['0x2C374eD1575e5C2C02c569f627299E902A1972cb', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  //   closedForStaking: false,
  // },
  BombMaxiBShareRewardPool: {
    name: 'Earn BSHARE by BOMB Maxi LP',
    poolId: 7,
    sectionInUI: 2,
    contract: 'BombMaxiBShareRewardPool',
    depositTokenName: '80BOMB-20BTCB',
    earnTokenName: 'BSHARE',
    finished: true,
    sort: 0,
    closedForStaking: false,
  },
  BshareMaxiBShareRewardPool: {
    name: 'Earn BSHARE by BOMB Maxi LP',
    poolId: 8,
    sectionInUI: 2,
    contract: 'BshareMaxiBShareRewardPool',
    depositTokenName: '80BSHARE-20WBNB',
    earnTokenName: 'BSHARE',
    finished: true,
    sort: 1,
    closedForStaking: false,
